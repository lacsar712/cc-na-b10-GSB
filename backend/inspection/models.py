...
class Inspection(models.Model):
    ...
    visibility = models.CharField("能见度", max_length=100, blank=True, null=True)
    tide_level = models.CharField("潮位", max_length=100, blank=True, null=True)
    lantern = models.CharField("灯器", max_length=100, blank=True, null=True)
